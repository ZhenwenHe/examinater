...
import cn.edu.cug.cs.exam.filters.SingleChoiceQuestionFilter;
import cn.edu.cug.cs.exam.filters.MultiChoiceQuestionFilter;
import cn.edu.cug.cs.exam.filters.ShortAnswerQuestionFilter;
import cn.edu.cug.cs.exam.filters.BlankFillingQuestionFilter;
import cn.edu.cug.cs.exam.filters.TrueFalseQuestionFilter;
import cn.edu.cug.cs.exam.filters.ProblemSolvingQuestionFilter;
import cn.edu.cug.cs.exam.filters.SynthesizedQuestionFilter;
...
public class Extractor {
    ...
    public Extractor(Filter filter) {
        this.filter = filter;
    }
     ...
     * @throws Exception
     */
    public static ArrayList<String> parseText(String fileDocument, Filter filter) throws Exception{
        String[] paragraphs = TextExtractor.parseToStrings(fileDocument);
        ArrayList<String> ss= new ArrayList<>();
        //查找试题开始的前一行，此行向上的部分全部剔除
        int i =0;
